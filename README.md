...
- Timestamp: `2022-06-16 16:37`
- Build ID: `217736d0-0bf1-4be8-aaf8-e0ddd20f6cd2`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/217736d0-0bf1-4be8-aaf8-e0ddd20f6cd2.git
$ cd 217736d0-0bf1-4be8-aaf8-e0ddd20f6cd2
```
